...
class Freight_model extends CI_Model
{
    ...
    {
        $this->db->select('tbl_seller_requirement.*,tbl_seller_requirement.id as request_id,tbl_shipment.type as shipment,tbl_deliver_term.name as delivery_term_name,tbl_mode.type as mode,tbl_company.name as ff_company_name,t5.title as quote_status_title');
    ...
    {
        $this->db->select('t1.*,t1.id as request_id,t3.type as shipment,t2.name as delivery_term_name,t4.type as mode,t5.ff_company_id,t5.quote_status,t5.quote_submit_dt,t5.counter_rate_update_status,t5.counter_rate_update_dt,t5.ff_id,t5.total_quote_amount,t5.counter_rate,t1.port_loading_name as loading_port, t1.port_discharge_name as discharge_port,t5.ff_payment_term,t6.title as status_title');
    ...
    {
        $this->db->select('t1.*,ROUND((t1.length*t1.width*t1.height)/1000000,1) as volume,ROUND((t1.length*t1.width*t1.height)/5000,1) as volumetric_weight,
