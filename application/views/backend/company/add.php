                   ...
                   <form class="col s12" id="registerForm" action="" method="POST">
                     ...
                     <div class="row">
                       <div class="input-field col s6">
                         <input id="firstname" name="firstname" type="text" aria-required="true" maxlength="25" value="<?=set_value('firstname')?>">
                         <label for="firstname">First Name <sup>*</sup></label>
                       </div>

                       <div class="input-field col s6">
                         <input id="lastname" name="lastname" type="text" aria-required="true" maxlength="25" value="<?=set_value('lastname')?>">
                         <label for="lastname">Last Name <sup>*</sup></label>
                       </div>
                  </div>
                  <div class="row">
                       <div class="input-field col s6">
                         <input id="email" name="email" type="text" aria-required="true" maxlength="50" value="<?=set_value('email')?>">
                         <label for="email">Email <sup>*</sup></label>
                       </div>
                       <div class="input-field col s6">
                         <input id="phone" name="phone" type="text" maxlength="15" value="<?=set_value('phone')?>">
