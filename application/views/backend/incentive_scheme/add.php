              ...
              <div class="row">
                <div class="col s12 m12 l8 offset-l2">
                  <div class="card-panel">
                    ...
                    <div class="row">
                      <form class="col s12" id="formData" action="<?php echo base_url('admin/incentive-scheme/add');?>" method="POST">
                        <div class="row">
                          <div class="input-field col s12">
                            ...
                            <label for="unit_type">Incentive Scheme Name</label>
                          </div>
                       </div>
                          <div class="row">
                            <div class="input-field col s12">
                              <button class="btn cyan waves-effect waves-light right" type="submit" name="doSubmit"  value="doSubmit" name="action">Add Incentive Scheme<i class="mdi-content-send right"></i>
                              </button>
                            </div>
                          </div>
                      </form>
