                    ...
                    <div class="customer-login-block Registers">
                        ...
                        <form action="<?php echo base_url('signup'); ?>" method="post" id="registerForm">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline2" name="user_type" class="custom-control-input" value="Freight Forwarder">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="firstname" placeholder="First Name" maxlength="25" />

                            </div>

                            <div class="form-group">
                                <!--   <label>Last Name: </label>-->
                                <input type="text" class="form-control" name="lastname" placeholder="Last Name" maxlength="25" />
                            </div>
                            ...
                            <div class="form-group">
                                <!--<label>Phone: </label>-->
                                <input type="text" class="form-control" name="phone" id="phone" placeholder="Mobile" maxlength="15" />
                       ...
                       <label id="otp-error" class="error" for="otp" style="display:none"></label>
                            ...
                            <div class="form-group">
                                ...
                                <input autocomplete="off" type="password" class="form-control" name="password" id="password" maxlength="15" placeholder="Password" />
                            </div>

                            <div class="form-group">
                                <!--<label>Confirm Password: </label>-->
                                <input autocomplete="off" type="password" class="form-control" name="confirm_password" maxlength="15" placeholder="Confirm Password" />
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <img class="captcha-image" src="<?= base_url() . 'captcha' ?>"><i class="fa fa-refresh refresh-captcha text-primary"></i>
                                </div>
                            </div>
                            <div class="form-group"><label for="captcha">Please Enter the Captcha Text</label><br>
                                <input type="text" id="captcha" class="form-control" name="captcha_challenge" required>
                            </div>
                            <div class="form-group">
