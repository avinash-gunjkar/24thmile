...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.4.2/chosen.css" />
   ...
   <div class="wshipping-content-block">
       ...
       <div class="row">
        ...
        <form name="profileForm" id="profileForm" action="<?php echo base_url('add-branch/'.$type); ?>" method="post" enctype="multipart/form-data">
<!--             <h3>User Details</h3>-->
             <div class="row">
             ...
             <div class="col-12">
                <div class="form-row mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="pincode" id="pincode"  placeholder="Pin code" maxlength="50" value="<?php echo $branch_details->pincode?>" >
                    </div>
                     <div class="col">
                ...
                <div class="form-row mb-3">
                    ...
                    <div class="col">
                       ...
                       <input type="text" class="form-control" name="phone" id="phone"  placeholder="Branch phone number" maxlength="50" value="<?php echo $branch_details->phone?>" >
                    </div>
                    <div class="col">
                            <label>Branch fax number</label>
                        <input type="text" class="form-control" name="fax" id="fax"  placeholder="Branch fax number" maxlength="50" value="<?php echo $branch_details->fax?>" >
                    </div>
                ...
                <div class="form-row mb-3">
                 ...
                 <div class="col-12">
                              ...
                              <a href="<?= base_url('company-branch');?>" class="btn btn-secondary ">Cancel</a>
                        </div>
                 </div>
        </form>
