                          ...
                          <tbody>
                              <?php foreach ($branch_list as $key=>$branch) { ?>
                                <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url('edit-branch/'.$branch->id . '/' . $type)?>"   title="Edit"  class="fa fa-pencil fa-lg text-info" ></a>
                                      <a href="<?= base_url('delete-branch/'.$branch->id .'/' . $type)?>"  title="Delete" class="fa fa-trash fa-lg text-danger deleteConfirm" ></a>
                                  </td>
                                </tr>
                              <?php }?>
