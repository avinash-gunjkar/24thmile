                                 ...
                                 <div class="row">
                                         ...
                                         <div class="col-12 col-lg-3">
                                                 <div class="form-group">
                                                         ...
                                                         <input type="text" required class="form-control width-150 decimal-numbers" id="step8_import_invoice_number" name="step8_import_invoice_number" value="<?php echo isset($bookedShipment->invoice_number) ? $bookedShipment->invoice_number : ''; ?>" />
                                                 </div>
                                         </div>
                                         ...
                                         <div class="col-12 col-lg-3">
                                                 <div class="form-group">
                                                         ...
                                                         <input type="text" required class="form-control width-150 decimal-numbers" id="step8_import_invoice_amount" name="step8_import_invoice_amount" value="<?php echo isset($bookedShipment->Invoice_amount) ? $bookedShipment->Invoice_amount : ''; ?>" />
                                                 </div>
                                         </div>
