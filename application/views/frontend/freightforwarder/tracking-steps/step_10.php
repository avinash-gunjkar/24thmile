                                 ...
                                 <div class="row">
                                         ...
                                         <div class="col-12 col-lg-4">
                                                 <div class="form-group">
                                                         ...
                                                         <input type="text" required="" class="form-control width-150 decimal-numbers" id="step10_export_invoice_number" name="step10_export_invoice_number" value="<?php echo isset($bookedShipment->invoice_number) ? $bookedShipment->invoice_number : ''; ?>" />
                                         ...
                                         <div class="col-12 col-lg-4">
                                                 <div class="form-group">
                                                         ...
                                                         <input type="text" required="" class="form-control width-150 decimal-numbers" id="step10_export_invoice_amount" name="step10_export_invoice_amount" value="<?php echo isset($bookedShipment->Invoice_amount) ? $bookedShipment->Invoice_amount : ''; ?>" />
                                                 </div>
                                         </div>
