	...
	<?php } ?>
 			...
 			<script>
 				$('#step11_submit_btn_1').click(function() {
 					$('#step11_export_erbc_number').attr('required', true);
 					$('#erbc_date').attr('required', true);

 					$('#step11_export_dbk_received').attr('required', false);

 					$('#step11_export_meis_received').attr('required', false);

 					$('#step11_export_bill_amnt_received').attr('required', false);
 				});
 				$('#step11_submit_btn_2').click(function() {
 					$('#step11_export_erbc_number').attr('required', false);
 					$('#erbc_date').attr('required', false);

 					$('#step11_export_dbk_received').attr('required', true);
 				...
 				$('#step11_submit_btn_3').click(function() {
 					...
 					$('#step11_export_meis_received').attr('required', true);
 				...
 				$('#step11_submit_btn_4').click(function() {
 					...
 					$('#step11_export_bill_amnt_received').attr('required', true);
 				});
 			</script>
