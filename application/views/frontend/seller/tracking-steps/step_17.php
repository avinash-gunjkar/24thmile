  <fieldset <?php echo ($currentStep->step_id == $stepData[$key]->id) ? 'style="opacity: 1; display: block;"' : '' ?>>
      ...
      <div class="shipping-form">
          <h3>Custom Documents / Bill of Entry <?php echo $status; ?></h3>
          <div class="row">
              <div class="radio">
              ...
              <?php } else { ?>
                  ...
                  <div class="col-12 col-lg-4">
                      <div class="form-group">
                          <label>NEFT Payment Details: </label>
                          <div class="input-group">
                              <input type="text" autocomplete="off" required="" class="form-control" name="neft_payment_details_inbond" value="<?= $bookedShipment->neft_payment_details_inbond ?>" />
                          </div>
                      </div>
                  </div>
                  <div class="col-12 col-lg-4">
                      <div class="form-group">
                          <label> NEFT Payment Date</label>
                          <input type="text" required autocomplete="off" placeholder="DD-MM-YYYY" class="form-control date-picker width-150" name="neft_payment_date_inbond" value="<?= printFormatedDate($bookedShipment->neft_payment_date_inbond) ?>" />
              ...
              <?php } else { ?>
                  ...
                  <div class="col-12 col-lg-4">
                      <div class="form-group">
                          <label>NEFT Payment Details: </label>
                          <div class="input-group">
                              <input type="text" autocomplete="off" required="" class="form-control" name="neft_payment_details_exbond" value="<?= $bookedShipment->neft_payment_details_exbond ?>" />
                          </div>
                      </div>
                  </div>
                  <div class="col-12 col-lg-4">
                      <div class="form-group">
                          <label> NEFT Payment Date</label>
                          <input type="text" required autocomplete="off" placeholder="DD-MM-YYYY" class="form-control date-picker width-150" name="neft_payment_date_exbond" value="<?= printFormatedDate($bookedShipment->neft_payment_date_exbond) ?>" />
