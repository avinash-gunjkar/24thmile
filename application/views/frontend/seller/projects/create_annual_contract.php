                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a href="<?= base_url('assets/frontend/excel-file-templates/annual-contract-template.xlsx') ?>" class="hideLCL btn btn-sm btn-success">Download Excel File Template</a>
