                                ...
                                <div class="shipping-form-block">
                                    <!-- <div>
                                        ...
                                        <div class="dropdown pull-right">
                                            <button class="btn btn-primary dropdown-toggle my-2" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                               <i class="fa fa-plus"></i> Create Document
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <?php foreach ($documetTypeList as $documentType) { ?>
                                                <a class="dropdown-item" href="<?= base_url("fs-dms/create/$requestDetails->request_id/$documentType->document") ?>"><?= $documentType->name ?></a>
                                            <?php } ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table id="tableServerside" class="mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                <?php foreach ($documetTypeList['pre-shipment'] as $key=>$documentType) { ?>
                                                    <tr>
                                                        <td>
                                                            <?= $key+1 ?>
                                                        </td>
                                                       ...
                                                       <td class="text-left">
                                                        ...
                                                        <td>
                                                            <?php if($documentType->status=='0') {?>
                                                        <a class="btn btn-sm btn-primary" href="<?= base_url("fs-dms/create/$requestDetails->request_id/$documentType->document") ?>">Edit</a>
                                                        <?php }elseif($documentType->status=='1') {?>
                                                        <a class="btn btn-sm btn-primary" href="<?= base_url("fs-dms/create/$requestDetails->request_id/$documentType->document") ?>">Download</a>
                                                        <?php }else{?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <colgroup>
                                            ...
                                            <tbody>
                                            <?php foreach ($documetTypeList['post-shipment'] as $key=>$documentType) { ?>
                                                <tr>
                                                        <td>
                                                            <?= $key+1 ?>
                                                        </td>
