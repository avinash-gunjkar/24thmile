...
<div style="padding: 10px;">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-2 mb-3">
            ...
            <div class="input-group mb-3">
                <input type="number" class="form-control decimal-numbers"  name="container[<?= $containerCounter ?>][package][<?= $packageCounter ?>][so_number]"  value="<?= $item_details->so_number; ?>" min="1" aria-describedby="container[<?= $containerCounter ?>][package][<?= $packageCounter ?>][so_number]-error" />
            </div>
            <span id="container[<?= $containerCounter ?>][package][<?= $packageCounter ?>][so_number]-error" class="error"></span>
        </div>
        <div class="col-12 col-lg-2 mb-3">
            <label>SO# Line Item</label>
            <div class="input-group mb-3">
                <input type="number" class="form-control decimal-numbers"  name="container[<?= $containerCounter ?>][package][<?= $packageCounter ?>][so_line_item]"  value="<?= $item_details->so_line_item; ?>" min="1" aria-describedby="container[<?= $containerCounter ?>][package][<?= $packageCounter ?>][so_line_item]-error" />
            </div>
