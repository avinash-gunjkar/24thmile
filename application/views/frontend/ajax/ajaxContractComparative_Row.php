<tr class="list-container-item container_<?= $containerCounter ?>">
    ...
    foreach ($item_details->charges as $key_1 => $category) {
        echo "<td class='$changeBorderClass'>$category->categoryTotal</td>";
        $total +=     $category->categoryTotal;
    } ?>
    <td class="<?=$changeBorderClass?>"><?= $total ?></td>
    <td class="<?=$changeBorderClass?>"><?= $item_details->counter_rate ?></td>
    <td class="<?=$changeBorderClass?>">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th class='text-left'><input type="text" name="counter_rate" maxlength="15" value="<?=$item_details->counter_rate?>" class="form-control decimal-numbers"></th>
                            </tr>
                            </tfoot>
                        </table>
                        </div>
