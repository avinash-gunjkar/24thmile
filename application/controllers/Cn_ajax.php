           ...
           // $cell_collection = $objPHPExcel->getActiveSheet()->getCellCollection();
            ...
            foreach ($allDataInSheet as $key=>$row) {
                ...
                if(!empty($containerCounter)){
                    $this->load->view('frontend/ajax/ajaxAddContainerPackage',['packageCounter'=>$packageCounter,'containerCounter'=>$containerCounter,'item_details'=>$item,'packingList'=>$packingList]);
                }else{
                    $this->load->view('frontend/ajax/ajaxAddPackage',['packageCounter'=>$packageCounter,'containerCounter'=>$containerCounter,'item_details'=>$item,'packingList'=>$packingList]);
                }
       ...
       //   vdebug([$modeList,$shipmentList]);
        ...
        //    vdebug([$_POST,$allDataInSheet]);
           ...
           foreach ($allDataInSheet as $key=>$row) {
               ...
               $riders = $this->freight_model->getAnnualContractRiders($mode_id);
